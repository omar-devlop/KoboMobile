class KoboUser {
  ...
  factory KoboUser.fromJson(Map<String, dynamic> json) => KoboUser(
    ...
    isSuperuser:
        json['is_superuser'] != null ? (json['is_superuser'] as bool) : false,
    gravatar: json['gravatar'] ?? '',
    isStaff: json['is_staff'] != null ? (json['is_staff'] as bool) : false,
    ...
    validatedPassword:
        json['validated_password'] != null
            ...
            : false,
    acceptedTos:
        json['accepted_tos'] != null ? (json['accepted_tos'] as bool) : false,
  );
}
...
class ExtraDetails {
  ...
  factory ExtraDetails.fromJson(Map<String, dynamic> json) => ExtraDetails(
    ...
    requireAuth:
        json['require_auth'] != null ? (json['require_auth'] as bool) : false,
